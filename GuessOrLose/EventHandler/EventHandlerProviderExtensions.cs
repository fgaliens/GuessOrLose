namespace GuessOrLose.EventHandler
{
    public static class EventHandlerProviderExtensions
    {
        ...
        public static void OnError<T>(this IEventHandlerProvider<T> eventHandlerProvider, Exception error)
        {
            eventHandlerProvider.OnError(error);
        }

        public static void OnCompleted<T>(this IEventHandlerProvider<T> eventHandlerProvider)
        {
            eventHandlerProvider.OnCompleted();
        }
